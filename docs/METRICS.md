...
- **Recently Active** — the last observed local event is 12 seconds to five minutes old, with no qualifying attention marker. This is the normal state after an agent stops producing local activity while its runtime is present or presence is not decisive.
