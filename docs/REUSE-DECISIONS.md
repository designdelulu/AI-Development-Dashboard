...
- **Execution harnesses** stay outside this product. The dashboard does not clone orchestrators, mailboxes, or worktrees. A future adapter may observe a harness run; it will not reimplement one.
