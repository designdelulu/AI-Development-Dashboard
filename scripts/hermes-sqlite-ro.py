...
try:
    ...
    if not table_exists(conn, "sessions"):
        print(json.dumps({"supported": False, "probe": "unsupported", "sessions": [], "modelUsage": [], "turnLeases": []}))
        raise SystemExit(0)
    ...
    if operation == "live":
        ...
        print(json.dumps({"supported": True, "probe": "ok", "sessions": sessions, "modelUsage": [], "turnLeases": leases}))
    else:
        ...
        print(json.dumps({"supported": True, "probe": "ok", "sessions": sessions, "modelUsage": usage, "turnLeases": []}))
except Exception:
    print(json.dumps({"supported": False, "probe": "unavailable", "sessions": [], "modelUsage": [], "turnLeases": []}))
