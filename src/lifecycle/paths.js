...
export function lifecyclePaths({ root, dataDir = process.env.AI_DASHBOARD_DATA_DIR } = {}) {
  ...
  return { dataDir: resolvedData, runtimeFile: path.join(resolvedData, 'runtime.json'), logFile: path.join(resolvedData, 'runtime.log'), configDir: resolvedData, home: os.homedir() };
}
