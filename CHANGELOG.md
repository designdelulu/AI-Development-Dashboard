...
- Maintenance Runtime & Resources console with local health, resources, diagnostics, and owned-dashboard restart/stop controls.
- Privacy-safe local bug-report bundles with optional user-selected screenshots, a laptop-first review flow, and public issue templates.
- Local accent customization within the Design Delulu dark visual system.

This is an early beta. Unsupported telemetry remains unavailable rather than inferred, and Local Core does not require an account.
